...
namespace Sistem_Ventas.Areas.Clientes.Pages.Account
{
    ...
    public class RegistrarModel : PageModel
    {
        ...
        private static List<TClientes> clienteList;
        ...
        private bool setEditar(string Email)
        {
            try
            {
                ...
                {
                    clienteList = _objeto._context.TClientes.Where(u => u.Email.Equals(Email)).ToList();
                    Input = new InputModel
                    {
                        ID=clienteList[0].ID,
                        Nombre = clienteList[0].Nombre,
                        Apellido = clienteList[0].Apellido,
                        NID = clienteList[0].NID,
                        Telefono = clienteList[0].Telefono,
                        Email = clienteList[0].Email,
                        Direccion = clienteList[0].Direccion,
