...
namespace Sistem_Ventas.Areas.Clientes.Pages.Account
{
    ...
    public class ReportesModel : PageModel
    {
        ...
        private static  IList<TReportes_clientes> clienteReport { get; set; }
        private static TClientes cliente { get; set; }
                ...
                if (new EmailAddressAttribute().IsValid(email))
                {
                    ...
                    if (0 < clientesList.Count)
                    {
                        ...
                        /*   if (ticket != null)
                           ...
                           {
                               var list = _objeto._context.TReportes_clientes.Where(u => u.TClientes.Equals(cliente)).Last();
