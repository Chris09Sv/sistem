...
namespace Sistem_Ventas.Areas.Clientes.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        public ClientesController(SignInManager<IdentityUser> signInManager, ApplicationDbContext context, IListObject objeto,
        ...
        public async Task<IActionResult> Export()
        {
            ...
            String[] titles = { "ID", "No. Identidad", "Nombre", "Apellido", "Email", "Telefono", "Direccion","Clientes" };
            var export = new ExportData<TTicket>(_objeto._environment, Request, list, titles, "Clientes.xlsx", "Listado Clientes");
