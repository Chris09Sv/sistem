...
namespace Sistem_Ventas.Data.Migrations
{
    ...
    [Migration("20200218191801_migration7")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sistem_Ventas.Areas.Proveedores.Models.TProvedores", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TProvedores");
                });

            modelBuilder.Entity("Sistem_Ventas.Areas.Proveedores.Models.TReportes_provedores", b =>
                {
                    ...
                    b.Property<int?>("TProvedoresID");

                    b.Property<string>("Ticket");

                    b.HasKey("ReportesID");

                    b.HasIndex("TProvedoresID");

                    b.ToTable("TReportes_provedores");
                });
            ...
            modelBuilder.Entity("Sistem_Ventas.Models.TTicket", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Sistem_Ventas.Areas.Proveedores.Models.TReportes_provedores", b =>
                {
                    b.HasOne("Sistem_Ventas.Areas.Proveedores.Models.TProvedores", "TProvedores")
                        .WithMany("TReportes_provedores")
                        .HasForeignKey("TProvedoresID");
                });
